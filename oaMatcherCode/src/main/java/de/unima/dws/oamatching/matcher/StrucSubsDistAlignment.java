...
public class StrucSubsDistAlignment extends BaseMatcher {
	final static Logger logger = LoggerFactory
			.getLogger(StrucSubsDistAlignment.class);
	...
	public void init(Object o1, Object o2, Object ontologies)
		...
		if (!(getOntologyObject1() instanceof HeavyLoadedOntology && getOntologyObject1() instanceof HeavyLoadedOntology))
			throw new AlignmentException(
					"StrucSubsDistAlignment requires HeavyLoadedOntology ontology loader");
	}
				...
				for (i = 0; i < nbclass1; i++) {
					...
					if (nba1 > 0) { // if not, keep old values...
						...
						for (j = 0; j < nbclass2; j++) {
							...
							classmatrix[i][j] = classmatrix[i][j] + pic2
									* (2 * attsum / (nba1 + nba2));
						}
					}
				}
