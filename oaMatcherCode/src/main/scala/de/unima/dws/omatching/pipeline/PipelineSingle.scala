...
object PipelineSingle {
  def main(args: Array[String]): Unit = {
   /* val file_onto1: File = new File("ontos/2014/conference/confOf.owl");

    val file_onto2: File = new File("ontos/2014/conference/ekaw.owl");

    val gs_align: String = "ontos/2014/conference/reference-alignment/confOf-ekaw.rdf"
